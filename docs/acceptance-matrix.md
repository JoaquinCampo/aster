...
| V01 Risk-proportional deterministic-first verification and maker/checker/fixer | M4 | Partial | `workflow.rs`, `orchestration.rs`; `verification_workflow`, `v01_local_gaps` | Typed policy DAG now executes durably end-to-end; checker verdict-driven conditional fixer rounds and high-risk gates remain |
